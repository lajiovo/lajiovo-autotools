...
# 目标地址（本地绑定的应用）
TARGET_HOST = get_config("musicdl.network.target_host", default="127.0.0.1")
TARGET_PORT = get_config("musicdl.network.target_port", default=37777)

# 对局域网开放的监听地址和端口
LISTEN_HOST = get_config("musicdl.network.listen_host", default="0.0.0.0")
LISTEN_PORT = get_config("musicdl.network.listen_port", default=37777)
