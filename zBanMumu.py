...
# 1. 配置需要处理的文件夹目标
FOLDER_TARGETS = {
    "dir": r"C:\Users\？\AppData\Roaming\Netease\MuMuPlayer\data",
    "items": ["ProgramAds", "startupImage", "msgCenter"]
}

# 2. 配置需要处理的文件目标
FILE_TARGETS = {
    "dir": r"\MuMuPlayer\nx_main",
    "items": ["MuMuNxService.exe", "MuMuNxUpdater.exe", "MumuRemoteHealthd.exe"]
}
